// Reed-Solomon ECC Testbench  –  issue-12
// DUT: reed_solomon_ecc wrapper (results/issue-12/rtl/reed_solomon_ecc.v)
...
module reed_solomon_ecc_tb;
    ...
    initial begin
        $dumpfile("results/issue-12/build/reed_solomon_ecc_tb.vcd");
    ...
    initial begin
        ...
        $display("=== Reed-Solomon ECC Testbench START (issue-12) ===");
